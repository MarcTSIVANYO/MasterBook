...
$idmessage=$_GET['msg'];
$sqlread=$classemail->lire_un_msg_envoye($_SESSION['appmail']['id_pers'],$idmessage);
...
<tr>
   <td>&Agrave;</td><td><?php $sqldest=$classemail->ListDestMsgEnvoye($idmessage);
...
<tr>
   <td>Pi&egrave;ce(s) jointe(s)</td><td><?php
